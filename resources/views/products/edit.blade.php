        ...
        <div class="bg-white rounded-xl shadow-sm p-6">
            <form action="{{ route('products.update', $product) }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="space-y-6">
                        ...
                        <div>
                            ...
                            <div class="relative">
                                ...
                                <input type="text" name="price" id="price" 
                                    value="{{ old('price') ? number_format(old('price'), 0, ',', '.') : number_format($product->price, 0, ',', '.') }}" required
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        <div>
                            <label for="stock" class="block text-sm font-medium text-gray-700 mb-2">Stok Saat Ini</label>
                            <input type="number" name="stock" id="stock" value="{{ $product->stock }}" readonly
                                min="0"
                                class="w-full px-4 py-2 border border-gray-300 rounded-lg bg-gray-100 cursor-not-allowed">
                            <p class="mt-1 text-xs text-gray-500">Stok tidak dapat diubah melalui form edit. Gunakan fitur
                                Stock Opname untuk penyesuaian stok.</p>
                        </div>
                    ...
                    <!-- SKU (Internal ID) -->
                    <div>
                        <label for="sku" class="block text-sm font-medium text-gray-700 mb-2">SKU (ID
                            Internal)</label>
